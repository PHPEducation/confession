...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-8">
                {!! Form::model($topic, ['method' => 'PUT', 'route' => ['topics/updateAll', $topic->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                <div class="form-body">
                    {{--name--}}
                    <div class="form-group form-md-line-input {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('name', old('name_topic'), ['class' => 'form-control input_slug']) !!}
                    ...
                    <div class="form-group form-md-line-input {{ $errors->has('slug') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('slug', old('slug_topic'), ['class' => 'form-control output_slug']) !!}
                        ...
                        <div class="col-md-9">
                            ...
                            <div id="file-upload-form" class="uploader">
                                ...
                                <label for="file-upload" id="file-drag">
                                    ...
                                    <input name="images" value="" id="file-image-input" class="hidden"/>
                                    <div id="start">
